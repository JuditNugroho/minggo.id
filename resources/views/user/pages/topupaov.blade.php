                            ...
                            <div class="form-style-10">
                                ...
                                <form action="{{route('prosestopupaov')}}" method="GET">
                                    ...
                                    <div class="inner-wrap">
                                        <label>Player ID Anda<input type="text" id="id_player"  name="id_player" />
                                        ...
                                        <label>Pilih Dibawah ini
                                            <select class="form-control" id="hargavoucher">
                                                ...
                                                @foreach($topup as $pembayaran)
                                                    <option value="{{$pembayaran->harga}}">{{$pembayaran->list}} Voucher</option>
                                                @endforeach
                                            </select>
                                        </label>
                                    ...
                                    <div class="inner-wrap">
                                        ...
                                        <a class="btn btn-primary" href="#" role="button">Via Pulsa</a>
                                    </div>
